...
router.register(r'exhibitor/category-nested', views.ExhibitorCategoryNestedViewSet)
...
router.register(r'moderator/category-nested/(?P<exhibitor_id>\d+)', views.ModeratorCategoryNestedViewSet)
